...
public:
    ...
    virtual void calcSuccessorState(State const&, int const&, PDState&) const {}
...
public:
    ...
    //Murugeswari
    // void estimateQValue(State const&, int, double&) {}
    // void estimateQValues(State const&, std::vector<int> const&, std::vector<double>&) {}
    //:
