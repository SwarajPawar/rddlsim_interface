...
void Parser::parseTask(map<string, int>& stateVariableIndices,
    ...
    //Murugeswari
    SearchEngine::numActionFluents = numberOfActionFluents;
    //:
    ...
    //Murugeswari
    ProbabilisticSearchEngine::hasUnreasonableActions = false;
    DeterministicSearchEngine::hasUnreasonableActions = false;
